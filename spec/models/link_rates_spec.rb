...
describe LinkRate do
  ...
  context "recount rates" do
    ...
    it "should return total position" do
      ...
      described_class.total_to_position(link.link.link_rate.total).should eq(1)

      described_class.total_to_position(link3.link.link_rate.total).should eq(2)
    end
    ...
    it "should recount rates" do
      ...
      link1.link.link_rate.total.should eq(1)
      link2.link.link_rate.total.should eq(1)

      described_class.total_to_position(link1.link.link_rate.total).should eq(1)
      ...
      link1.link.link_rate.position.should eq(2)
      link2.link.link_rate.position.should eq(1)
      described_class.total_to_position(link3.link.link_rate.total).should eq(1)

      link2.link.link_rate.total.should eq(2)
      link1.link.link_rate.total.should eq(1)
      described_class.total_to_position(link1.link.link_rate.total).should eq(2)
    ...
    it "should recount rates with duplicate user_links" do
      ...
      described_class.total_to_position(link1.link.link_rate.total).should eq(1)
      described_class.total_to_position(link4.link.link_rate.total).should eq(2)

      link1.link.link_rate.total.should eq(2)
      link4.link.link_rate.total.should eq(1)
    end
